...
export function Hero({ products = [], loading = false, onOpenCart }: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 pt-28 pb-28 lg:pb-24">
        <div
        ...
        >
          {/* Brand narrative */}
          <div className={showCarousel ? 'text-left' : 'text-center'}>
            <p
            ...
            <h1
              className={`luxury-heading font-light leading-[1.05] tracking-tight mb-8 opacity-0 animate-fade-in-up ${
                showCarousel
            ...
            <div
              className={`luxury-divider mb-8 opacity-0 animate-fade-in-up ${
            ...
            <p
              className={`text-base sm:text-lg text-luxury-cream/70 leading-relaxed font-light opacity-0 animate-fade-in-up ${
            ...
            <div
              className={`flex flex-col sm:flex-row items-center gap-4 sm:gap-8 mt-10 opacity-0 animate-fade-in-up ${
          ...
          {loading && (
            <div
              className="opacity-0 animate-fade-in-up w-full max-w-md lg:max-w-none mx-auto"
